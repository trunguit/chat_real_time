                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-4 col-lg-5 col-md-7 col-sm-9">
                                ...
                                <div class="card border-0">
                                    <div class="p-4">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="form-label d-flex" for="password">Password <a
                                                            href="forgot.html" class="link link-primary ms-auto">Forgot
                                                            ?</a></label>
                                                    <div class="form-control-wrap">
                                            ...
                                            <div class="col-12">
                                                <button class="btn btn-primary w-100">Account Login</button>
                                            </div><!-- .col -->
                                        </div><!-- .row -->
                                    </div><!-- .p-4 -->
                            ...
                            <div class="text-center mt-4">
                                <p class="small">Don't have an account? <a><router-link
                                            to="/register">Register</router-link> </a></p>
                            </div>
                        </div><!-- .col -->
                    </div><!-- .row -->
                </div><!-- .container -->
