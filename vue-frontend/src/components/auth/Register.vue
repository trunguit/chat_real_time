                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-8">
                                ...
                                <div class="card border-0">
                                    <div class="p-4">
                                        ...
                                        <div class="row g-3 gx-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" v-model="formData.email" class="form-control"
                                                            id="email-address" placeholder="youremail@example.com">
                                                    </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="repeat-password">Password
                                                        Repeat</label>
                                                    <div class="form-control-wrap">
                                            ...
                                            <div class="col-12">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="privacy-term-agree"> I agree
                                                        with <a href="#">privacy policy &amp; terms</a>
                                                    </label>
                                                </div><!-- .form-check -->
                                            </div><!-- .col -->
                                            <div class="col-12">
                                                <button class="btn btn-primary w-100" type="submit">Account Register</button>
                                            </div><!-- .col -->
                                        </div><!-- .row -->
                                    </div><!-- .p-4 -->
                            ...
                            <div class="text-center mt-4">
                                <p class="small">Already have an account? <a ><router-link to="/login">Login</router-link> </a></p>
                            </div>
                        </div><!-- .col -->
                    </div><!-- .row -->
                </div><!-- .container -->
